...
const AVATARES_USUARIOS = {
  ...
  'DEFAULT': 'https://pbs.twimg.com/media/G4Hy8RAXYAArTrr.jpg' 
};
 ...
 const guardarLaptop = async (e) => {
  ...
  try {
    ...
    const datosFinales = { 
      ...
      // --- VALIDACIÓN DE RESPONSABLE (AUTORÍA) ---
      if (!editandoId) {
        // Solo si es NUEVO, guardamos quién lo registra
        datosFinales.responsable = usuarioLogueado?.nombre || "Sin Nombre";
        ...
        // Si estamos EDITANDO, eliminamos estos campos para que NO se sobrescriban en Firebase
    ...
    return (
      <div id="login-root">
        <form className="login-box" onSubmit={(e) => { 
          ...
          <img src="https://media3.giphy.com/media/v1.Y2lkPTZjMDliOTUyYjdmd3V2bWNmcGkzMWMxN294dXlvNW1ibjd1ZW1qZnNrdjdxdWQ1NCZlcD12MV9naWZzX3NlYXJjaCZjdD1n/1vGyiwzG2wdNUxwane/200.gif" className="login-avatar" alt="logo" />
  ...
  <div className="inventory-view fade-in">
    ...
    {usuarioLogueado?.rol === 'super_admin' && (
      <div style={{ 
        ...
        <div>
          <div style={{ color: '#aaa', fontSize: '0.8rem', marginBottom: '5px' }}>GANANCIA PROYECTADA</div>
