...
const RegistroVentasView = ({
  ...
  const puedeVerPrecioVenta = usuarioLogueado?.rol !== 'admin_2' && usuarioLogueado?.rol !== 'administrador_ventas';
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', color: '#e2e8f0', fontSize: '14px' }}>
                ...
                <tbody>
                  {laptops && laptops.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="4" style={{ textAlign: 'center', padding: '20px', color: '#64748b' }}>No hay registros disponibles.</td>
                    </tr>
                  )}
                </tbody>
              </table>
