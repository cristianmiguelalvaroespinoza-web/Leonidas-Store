...
import './VentasView.css'; // Reutilizamos tus estilos geniales de la boleta
...
const DespachosView = ({ laptops, usuarioLogueado }) => {
  ...
  // Filtramos SOLO los equipos que ya fueron despachados
  ...
  return (
    <div className="ventas-view-container fade-in">
      <div className="section-header">
        <h2 style={{ color: '#fff', margin: 0 }}>📦 HISTORIAL DE DESPACHOS</h2>
      ...
      {/* MODAL DE GUÍA DE ENVÍO (SIN PRECIOS) */}
      {mostrarGuia && equipoDetalle && (
        <div className="overlay-informe-leonidas" style={{ backgroundColor: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(3px)' }}> {/* Fondo más suave */}
